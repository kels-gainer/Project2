      ...
      firebase.auth().onAuthStateChanged(function(user) {
        ...
        if (user) {
          ...
          //added steps to disable un-necessary buttons while logged in
            $("#quickstart-sign-up").attr({disabled: true});
            $("#quickstart-password-reset").attr({disabled: true});
            $("#welcome-account").html("<p>You are currently logged in as: " +user.email +"</p>");
          // [END_EXCLUDE]
        } else {
          // User is signed out.
          // [START_EXCLUDE]
          ...
          $("#quickstart-sign-up").attr({disabled: false});
          $("#quickstart-password-reset").attr({disabled: false});
          var welcomeHTML = "<p>Enter an email and password below and either sign in to an existing account or sign up</p>" +
